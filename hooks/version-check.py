...
def main() -> None:
    ...
    if _VERSION_FILE.exists():
        ...
        if stored != current:
            ...
            print("  2. Update version in guide.md (intro, T7) and index.html footer")
            print("  3. Test hooks:  claude --version && echo 'hooks still load'")
            print("  4. Test MCP:    claude mcp list | grep github")
            print("  5. Review changelog for breaking changes")
            print("---\n")
            try:
