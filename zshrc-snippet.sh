...
# alias llm-code='ollama run qwen2.5-coder:7b'   # ~4.7 GB
...
llm-smart() {
  ...
  local model=""
  case "$task" in
    code)   model="qwen2.5-coder:7b" ;;   # match the tag you actually pulled
